...
public class GreaterThanExpr extends EquationExpr
{

	public GreaterThanExpr(SourceLocation sourceLocation, Expression<Integer> double1, Expression<Integer> double2)
	{
